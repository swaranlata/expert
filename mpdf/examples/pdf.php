...
$header='<tr>
	<td>
		<table border="0" cellspacing="0" cellpadding="0" width="100%"  style="@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
			<tr style="background-color: #01e0fc;/*background-image: url('.site_url().'/html/images/headerBg.jpg);*/">
				<td style="padding: 10px 15px;"><a href="#"><img src="'.site_url().'/html/images/logo.png" style="max-width: 160px;" alt="Expert Reports"></a></td>
				<td style="padding: 10px 15px;"><span style="background-color: #000;color: #fff;display: block;font-size: 28px;padding: 10px 30px;width: 100%;"><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>Pre-Remediation Report<span>&nbsp;&nbsp;&nbsp;&nbsp;</span></span></td>
				<td style="padding: 10px 15px;" align="right"><img src="'.site_url().'/html/images/rightLogo.png" alt="Full Licensed & Insured"></td>
			</tr>
			<tr>
				<td colspan="3" align="right" style="background-color: #fff;font-size: 18px;font-weight: 700;padding: 10px 30px;">Priscilla Kercado <span style="color: #01e0fc;font-size: 16px;">122 Chicago Woods Cir, Orlando, FL 32824</span></td>
			</tr>
		</table>
	</td>
</tr>';
$headerE=$header;
$footer='<tr>
	<td><div style="@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');background-color: #000;color: #fff;font-size: 16px;font-family: \'PT Sans\', sans-serif;padding: 4px 0px;text-align: center;">Phone:  1-844-344-MOLD | www.expertreports.com</div></td>
</tr>';
$footerE=$footer;
...
<body style="margin: 0;padding: 0;/*background:#f1fded*/">
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%" style="background: #fff;padding: 15px;">
					...
					<tr>
						<td style="padding-bottom: 15px;padding-top: 30px;">Dear Jone,</td>
					</tr>
					...
					<tr>
						<td>
							...
							<br>
							<p>Please review the entire report as many common questions are answered throughout.  If you have any questions please feel free to contact us at <a style="color: #01e0fc; text-decoration: none; font-weight: 600;" href="tel:844344-6653">(844) 344-MOLD (6653)</a>.</p>
							<br>
							<p>You are welcome to also communicate with our office by email since this allows for faster customer service.  Requests for revisits or clarifications must be made by email, if possible. Our email address is <a  style="color: #01e0fc; text-decoration: none; font-weight: 600;" href="mailto:info@moldexpert.com">info@moldexpert.com</a>. Please visit <a  style="color: #01e0fc; text-decoration: none; font-weight: 600;"href="http://www.moldexpert.com" target="_blank">www.moldexpert.com</a> for more information and reference purposes.</p>
							<br>
							...
							<div style="float: right;">
								...
								<p style="text-align: right;"><img style="max-width:80px;margin:10px 0;" src="'.site_url().'/html/images/sign.png" alt=""></p>
	...
	$html1= '<table  style="@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;" >
			...
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<td width="35%" align="left" style="background-color: #000;color: #fff;padding: 20px 30px;">
							<p><strong style="color: #2590c4;display: block;">Inspector:</strong><span>&nbsp;&nbsp;&nbsp;</span><span>Enrique Villamar</span></p><br>
							<p><strong style="color: #2590c4;display: block;">License:</strong><span>&nbsp;&nbsp;&nbsp;</span><span>MRSA2320</span></p><br>
							<p><strong style="color: #2590c4;display: block;">Date Tested:</strong><span>&nbsp;&nbsp;&nbsp;</span><span>2017-12-28</span></p><br>
							<p><strong style="color: #2590c4;display: block;">Inspection Type:</strong><span>&nbsp;&nbsp;&nbsp;</span><span>Pre Inspection</span></p>
						</td>
					</tr>
					<!-- /Inspector Content -->
					...
					<tr>
						...
						<td width="35%" style="background-color: #231f20;color: #fff;padding: 5px 20px;">
							<span><img src="'.site_url().'/html/images/cloud.png" alt="weather" style="display: inline-block;vertical-align: middle;max-width: 40px;border-radius: 50%;"> <span style="display: inline-block;vertical-align: middle;">Clear</span></span>
							<span>&nbsp;&nbsp;&nbsp;</span>
							<span style="margin-left: 20px;"><img src="'.site_url().'/html/images/temper.png" alt="Temperature" style="display: inline-block;vertical-align: middle;max-width: 40px;border-radius: 50%;"> <span style="display: inline-block;vertical-align: middle;">64° F</span></span>
						</td>
					</tr>
					<!-- /Inspector Weather Section -->
					...
					<tr>
						<td colspan="2" style="border: 1px solid #c7c7c7;">
							<table border="0" cellspacing="15" cellpadding="0" width="100%">
								<tr>
									<td style="background-color: #01e0fc;">
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;vertical-align: middle;">
														<img src="'.site_url().'/html/images/error.png" alt="Error" style="max-width: 40px;width: 100%;">
													</span>
												</td>
												<td style="background-color: #01e0fc;padding: 10px;">
									...
									<td style="background-color: #01e0fc;">
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;vertical-align: middle;">
														<img src="'.site_url().'/html/images/ok.png" alt="Ok" style="max-width: 40px;width: 100%;">
													</span>
												</td>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;margin-left: 10px;vertical-align: middle;">
									...
									<td style="background-color: #01e0fc;">
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;vertical-align: middle;">
														<img src="'.site_url().'/html/images/warning.png" alt="Error" style="max-width: 40px;width: 100%;">
													</span>
												</td>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;margin-left: 10px;vertical-align: middle;">
								...
								<tr>
									<td colspan="2" style="background-color: #01e0fc;">
										<table border="0" cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;vertical-align: middle;">
														<img src="'.site_url().'/html/images/miscellaneous.png" alt="Error" style="max-width: 40px;max-width: 40px;">
													</span>
												</td>
												<td style="background-color: #01e0fc;padding: 10px;">
													<span style="display: inline-block;margin-left: 10px;vertical-align: middle;">
														<span style="display: block;font-size: 18px;font-weight: bold;">Toxic Mold</span>
														<span style="font-size: 14px;font-weight: normal;">Elevated Spore Counts</span>
														<span style="display: block;font-size: 12px;font-weight: 500;margin-top: 15px;">Penicillium/Aspergillus</span>
													</span>
												</td>
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="15" width="100%" style="margin-top: 20px;">
					<tr>
						<td>
							<p><strong>Type of Loss:</strong> VALUE text from ISN about the Loss</p>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="15" width="100%" style="margin-top: 0px;">
					<tr>
						<td>
	...
	$html2='<table  style="@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
		...
		<tr>
			<td style="border: 4px solid #01e0fc; background: #fff;">
				<table cellspacing="0" style="border-color: #01e0fc;width: 100%;" cellpadding="8">
					<tr>
						<td colspan="2" style="border-right: 1px solid #01e0fc;">
							<p>Lorem Ipsum</p>
							<p>
								It Park, Chandigarh<br>
								98880 98880<br>
								lorem@email.com
							</p>
						</td>
						<td colspan="2" cellpadding="0" style="border-top: 1px solid #01e0fc;padding: 0px;">
							<table cellpadding="8" cellspacing="0" cellspacing="" width="100%">
								<tr>
									<th align="left" style="background: #01e0fc;">Insurance Company</th>
									<td style="background: #01e0fc;">Lorem Ipsum</td>
								</tr>
								<tr>
								...
								<tr>
									<th align="left" style="background: #01e0fc;">Claim #</th>
									<td style="background: #01e0fc;">Lorem Ipsum</td>
								</tr>
								<tr>
					...
					<tr>
						<th align="left" style="background: #01e0fc;">Rehabbed After 1978</th>
						<th align="left" style="background: #01e0fc;">Yes</th>
						<th align="left" style="background: #01e0fc;">Claim Count</th>
						<td style="background: #01e0fc;">Lorem Ipsum</td>
					</tr>
					<tr>
					...
					<tr>
						<th align="left" style="background: #01e0fc;">Payment Type</th>
						<td style="background: #01e0fc;">AOB</td>
						<th align="left" style="background: #01e0fc;">Remediation Company</th>
						<td style="background: #01e0fc;">Lorem Ipsum</td>
					</tr>
					<tr>
		...
		<tr>
			<td>
				<table cellpadding="15" width="100%" style="border: 4px solid #01e0fc;margin-top: 30px; background: #fff">
					<tr>
						<td width="33.33%" valign="top">
                         <img src="'.site_url().'/html/images/image5.jpg">
							<!--div style="background-image: url(http://clientstagingdev.com/expertreports/html/images/image5.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;padding-bottom: 50%;"></div-->
						</td>
						<td width="33.33%" valign="top">
		...
		<!-- <tr>
			<td>
				<table cellpadding="15" width="100%" style="border: 1px solid #01e0fc; margin-top: 30px; background: #fff; padding: 2px;">
					<tr>
						<td style=" background: #01e0fc;">Lorem Ipsum</td>
					</tr>
					<tr>
						<td style="">Lorem Ipsum</td>
					</tr>
					<tr>
						<td style="background: #01e0fc;">Lorem Ipsum</td>
					</tr>
		...
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 30px; background: #01e0fc; padding: 15px;">
					<!--tr align="left">
						<th>HVAC System</th>
						<th>Visual</th>
						<th>Ductwork</th>
					...
					<tr>
						<td style="padding-top: 15px;"><strong>HVAC System: </strong>VALUE</td>
						<td style="padding-top: 15px;"><strong>Visual: </strong>VALUE</td>
						<td style="padding-top: 15px;"><strong>Ductwork: </strong>VALUE</td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td style="padding-top: 20px">
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td>
							<div style="background-color: #01e0fc;margin: 10px 0;padding: 10px;">
								<table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin: 10px 0;">
									<tr>
										<td style="background-color: #01e0fc;margin: 10px 0;padding: 10px;">
											<span style="display: inline-block;vertical-align: middle;">
												<img src="'.site_url().'/html/images/error.png" alt="Error" style="max-width: 40px;width: 100%;">
											</span>
										</td>
    ...
    <table width="100%" style="@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
		...
		<tr>
			<td>
				<table border="0" cellspacing="15" cellpadding="0" width="100%" style="border: 1px solid #01e0fc;margin-top: 15px; background: #fff;">
					<tr>
						<td>
	...
	<!-- Content -->
	<div style="margin-top: 30px; background: #fff; padding: 15px;@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
		<ul style="list-style: none;list-style-position: outside;margin: 0;padding: 0;">
			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Remove all materials affected by mold and/or water damage in an effort to restore abnormal conditions to normal indoor fungal ecology</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Abate the moisture source in an effort to help limit the reoccurrence of abnormal indoor fungal ecology</li>


			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> HVAC system (i.e. coil, insulation, fan motor, enclosure, etc.) must be cleaned and treated using a corrective method.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> HVAC duct work needs decontamination by applying anti-microbial agents, either directly or through the return.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Maintain HEPA filtered intake & positive exhaust air containment during remediation activity until post remediation verification is cleared.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> PPE for this remediation project is N-95 respirator with eye protection and Tyvek coveralls.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Sheetrock that shows signs of mold should first be HEPA vacuumed before removal, if it cannot be sanitized, then be removed carefully in large pieces.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Sheetrock should be removed at least 18 to 24 inches beyond contamination.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> All contaminated material and debris that have been removed will be disposed as regular waste after it is bagged and removed from the containment.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Any other affected substrate materials must be cleaned and treated in accordance with IICRC S520 Standards. If the compromised material cannot be restored, it must be removed and replaced.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Completely HEPA-Vacuum and then wet-wipe all vertical and horizontal surfaces in their entirety.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Entire condo/house/commercial building must be fogged with anti-microbial agents.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Containment area will be scrubbed for 24 hours after remediation prior to Post Remediation Verification. Air Scrubbers shall be turned off hours prior to the Post Remediation Verification. All remediated surfaces must be completely free of dust and debris.</li>

			<li style="margin-bottom: 15px;padding-left: 20px;position: relative;background-position: 2px 3px;background-size: 30px;background-repeat: no-repeat;background-image: url(http://clientstagingdev.com/expertreports/html/images/check.png);"> Post Remediation Verification will consist of a Visual, Olfactory, and duplicate samples that were part of the initial assessment by a Licensed Mold Assessor. If Post Remediation Verification is successful, the Licensed Mold Assessor will issue a Clearance Certificate to the client indicating no additional action is needed by remediator.</li>
		</ul>
	</div>
	<div style="margin-top: 30px; background: #fff; padding: 15px;@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
	...
	<div style="margin-top: 30px; background: #fff; padding: 15px;@import url(\'https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900\');font-family: \'PT Sans\', sans-serif;">
		...
		<ul>
			<li>
				...
				<a href="#">http://www.epa.gov/mold/</a></p>
			</li>
			<li>
				<p><strong>A Brief Guide to Mold, Moisture, and Your Home – </strong><br>
				<a href="#">www2.epa.gov/mold/brief-guide-mold-moisture-and-your-home</a></p>
			</li>
			<li>
				<p><strong>Should You Have the Air Ducts in Your Home Cleaned? – </strong><br>
				<a href="#">www2.epa.gov/indoor-air-quality-iaq/should-you-have-air-ducts-your-home-cleaned</a></p>
			</li>
			<li>
				<p><strong>Flood Cleanup - Avoiding Indoor Air Quality Problems – </strong><br>
				<a href="#">www2.epa.gov/indoor-air-quality-iaq/flood-cleanup-protect-indoor-air-quality</a></p>
			</li>
			<li>
				<p><strong>Center for Disease Control and Prevention (CDC) – </strong><br>
				<a href="#">http://www.cdc.gov/mold/</a></p>
			</li>
			<li>
				<p><strong>General Information – </strong><br>
				<a href="#">http://www.cdc.gov/mold/basics.htm</a></p>
			</li>
			<li>
				<p><strong>Cleanup and Remediation – </strong><br>
				<a href="#">http://www.cdc.gov/mold/cleanup.htm</a></p>
			</li>
			<li>
				<p><strong>Occupational Safety & Health Administration (OSHA) – </strong><br>
				<a href="#">http://www.osha.gov/SLTC/molds</a></p>
			</li>
			<li>
				<p><strong>American Academy of Allergy, Asthma & Immunology (AAAAI) – </strong><br>
				<a href="#">http://www.aaaai.org</a></p>
			</li>
			<li>
				<p><strong>Institute of Inspection, Cleaning and Restoration Certification (IICRC) – </strong><br>
				<a href="#">http://www.iicrc.org</a></p>
			</li>
		</ul>
	</div>
	<!-- /Content -->';
