...
<body style="margin: 0;padding: 0;">
	<table border="0" cellspacing="0" cellpadding="0" style="@import url('https://fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900');font-family: 'PT Sans', sans-serif;margin: 0 auto;max-width: 820px;width: 100%;">
		<tr>
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr style="background-image: url(images/headerBg.jpg);">
						<td style="padding: 10px 5px;">
							<a href="#"><img src="images/logo.png" style="max-width: 300px;" alt="Expert Reports"></a>
						</td>
						<td style="padding: 10px 5px;">
							<span style="background-color: #000;color: #fff;display: block;font-size: 28px;padding: 10px;">Pre-Remediation Report</span>
						</td>
						<td style="padding: 10px 5px;">
							<img src="images/rightLogo.png" alt="Full Licensed & Insured">
						</td>
					</tr>
					<tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td width="70%" style="position: relative;">
							<div class="imgWrapper" style="background-image: url(images/image1.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;bottom: 0;left: 0;position: absolute;right: 0;top: 0;"></div>
						</td>
						<td width="30%" align="right" style="background-color: #58ae1d;color: #fff;padding: 5px 30px;">
							<p><strong style="display: block;">Inspector:</strong><span>Enrique Villamar</span></p>
							<p><strong style="display: block;">License:</strong><span>MRSA2320</span></p>
							<p><strong style="display: block;">Date Tested:</strong><span>2017-12-28</span></p>
							<p><strong style="display: block;">Inspection Type:</strong><span>Pre Inspection</span></p>
						</td>
					</tr>
					<tr>
						...
						<td width="30%" style="background-color: #231f20;color: #fff;padding: 5px 20px;">
							<span><img src="images/cloud.png" alt="weather" style="display: inline-block;vertical-align: middle;"> <span style="display: inline-block;vertical-align: middle;">Clear</span></span>
							<span style="margin-left: 30px;"><img src="images/temper.png" alt="Temperature" style="display: inline-block;vertical-align: middle;"> <span style="display: inline-block;vertical-align: middle;">64° F</span></span>
						</td>
					</tr>
					<tr>
		...
		<tr>
			<td style="border: 1px solid #c7c7c7;">
				<table cellspacing="10">
					...
					<tr>
						<th align="left">Rehabbed After 1978</th>
						<th align="left">Yes</th>
						<th align="left">No</th>
					</tr>
					<tr>
						<th align="left">Type Of Inspection</th>
						<td colspan="2">APOB Mold</td>
					</tr>
					<tr>
					...
					<tr>
						<th align="left">Insurance Company</th>
					...
					<tr>
						<th align="left">Insueance Adjuster</th>
						<td colspan="2">Lorem Ipsum</td>
					</tr>
					<tr>
						<th align="left">Claim Count</th>
						<td colspan="2">Lorem Ipsum</td>
					</tr>
					<tr>
						<th align="left">Date Of Loss</th>
						<td colspan="2">12 Dec, 2017</td>
					</tr>
					<tr>
						<th align="left">Remediation Company</th>
						<td colspan="2">Lorem Ipsum</td>
					</tr>
					<tr>
		...
		<tr>
			<td>
				<table cellpadding="15" width="100%" style="border: 1px solid #c7c7c7;margin-top: 30px;">
					<tr>
						<td width="33.33%" valign="top">
							<div style="background-image: url(images/image5.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;padding-bottom: 50%;"></div>
						</td>
						<td width="33.33%" valign="top">
		...
		<tr>
			<td>
				<table cellpadding="15" width="100%" style="border: 1px solid #c7c7c7;margin-top: 30px;">
					<tr>
						<td style="border-bottom: 1px solid #c7c7c7;">Lorem Ipsum</td>
					</tr>
					<tr>
						<td style="border-bottom: 1px solid #c7c7c7;">Lorem Ipsum</td>
					</tr>
		...
		<tr>
			<td>
				<table border="0" cellspacing="15" cellpadding="0" width="100%" style="border: 1px solid #c7c7c7;margin-top: 15px;">
					<tr>
						<td>
							<div style="background-image: url(images/image3.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;padding-bottom: 50%;"></div>
						</td>
						<td>
							<div style="background-image: url(images/image4.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;padding-bottom: 50%;"></div>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<div style="background-image: url(images/image6.jpg);background-position: center;background-repeat: no-repeat;-webkit-background-size: cover;background-size: cover;padding-bottom: 50%;"></div>
						</td>
					</tr>
				</table>
			</td>
					...
					<tr>
						<td>
							<ul style="list-style: none;list-style-position: outside;margin: 0;padding: 0;">
								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Remove all materials affected by mold and/or water damage in an effort to restore abnormal conditions to normal indoor fungal ecology</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Abate the moisture source in an effort to help limit the reoccurrence of abnormal indoor fungal ecology</li>
				  

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> HVAC system (i.e. coil, insulation, fan motor, enclosure, etc.) must be cleaned and treated using a corrective method.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> HVAC duct work needs decontamination by applying anti-microbial agents, either directly or through the return.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Maintain HEPA filtered intake & positive exhaust air containment during remediation activity until post remediation verification is cleared.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> PPE for this remediation project is N-95 respirator with eye protection and Tyvek coveralls.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Sheetrock that shows signs of mold should first be HEPA vacuumed before removal, if it cannot be sanitized, then be removed carefully in large pieces.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Sheetrock should be removed at least 18 to 24 inches beyond contamination.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> All contaminated material and debris that have been removed will be disposed as regular waste after it is bagged and removed from the containment.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Any other affected substrate materials must be cleaned and treated in accordance with IICRC S520 Standards. If the compromised material cannot be restored, it must be removed and replaced.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Completely HEPA-Vacuum and then wet-wipe all vertical and horizontal surfaces in their entirety.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Entire condo/house/commercial building must be fogged with anti-microbial agents.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Containment area will be scrubbed for 24 hours after remediation prior to Post Remediation Verification. Air Scrubbers shall be turned off hours prior to the Post Remediation Verification. All remediated surfaces must be completely free of dust and debris.</li>

								<li style="margin-bottom: 15px;padding-left: 20px;position: relative;"><span style="left: 0;position: absolute;top: 0;">&#x2714;</span> Post Remediation Verification will consist of a Visual, Olfactory, and duplicate samples that were part of the initial assessment by a Licensed Mold Assessor. If Post Remediation Verification is successful, the Licensed Mold Assessor will issue a Clearance Certificate to the client indicating no additional action is needed by remediator.</li>
							</ul>
						</td>
					</tr>
				</table>
