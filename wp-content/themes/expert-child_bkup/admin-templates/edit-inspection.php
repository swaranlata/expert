...
if(isset($_POST['editInspectionDetails'])){
    $wpdb->query('update `im_inspection_details` set `outdoorTemprature`="'.$_POST['outdoorTemprature'].'",`hvacSystem`="'.$_POST['hvacSystem'].'",`bullets`="'.$_POST['bullets'].'",`ductwork`="'.$_POST['ductwork'].'",`hvacSystemValue`="'.$_POST['hvacSystemValue'].'",`spoke_count`="'.$_POST['spoke_count'].'" where `id`="'.$_GET['inspectionId'].'"');
    $msg='1';
}
