...
<div class="wrap">
	...
	$inspectionDetailsOrder=json_decode(file_get_contents('http://goisn.net/moldexpert/rest/order/'.$dbInspection['inspectionId'].'?username=swaran&password=admin@123'),true);
   $inspectionDetails=json_decode(file_get_contents('http://clientstagingdev.com/expertreports/api/getInspectionDetails.php?inspectionId='.$dbInspection['inspectionId'].'&username=inspector&password=123456'),true);
...
</html>'; include 'includes/footer.php'; ?>