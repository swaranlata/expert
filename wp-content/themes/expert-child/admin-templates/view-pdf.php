				...
				<table border="0" cellspacing="0" cellpadding="0" width="50%">
					<tr>
						<td style="padding: 10px;padding-left: 0;">
							...
							<span style="border-bottom: 1px solid #b5b5b5;display: block;font-size: 16px;font-weight: 600;padding: 5px 0px;">'. $v['temprature'].'</span>
						</td>
						<td style="padding: 10px;padding-right: 0;">
							...
							<span style="border-bottom: 1px solid #b5b5b5;display: block;font-size: 16px;font-weight: 600;padding: 5px 0px;">'. $v['rhRelativeHumidity'].'</span>
						</td>
					</tr>
				</table>
			</td>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr style="background-image: url('.site_url().'/html/images/headerBg.jpg);">
						<td style="padding: 10px 5px;">
							<a href="#"><img src="'.site_url().'/html/images/logo.png" style="max-width: 300px;" alt="Expert Reports"></a>
						</td>
						<td style="padding: 10px 5px;">
							<span style="background-color: #000;color: #fff;display: block;font-size: 28px;padding: 10px;">Post-Remediation Report</span>
						</td>
						<td style="padding: 10px 5px;">
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<td width="30%" style="background-color: #231f20;color: #fff;padding: 5px 20px;">
							<span><img src="'.site_url().'/html/images/cloud.png" alt="weather" style="display: inline-block;vertical-align: middle;"> <span style="display: inline-block;vertical-align: middle;">'.$dbInspection['hvacSystemValue'].'</span></span>
							<span style="margin-left: 30px;"><img src="'.site_url().'/html/images/temper.png" alt="Temperature" style="display: inline-block;vertical-align: middle;"> <span style="display: inline-block;vertical-align: middle;">'.$dbInspection['outdoorTemprature'].' F</span></span>
						</td>
					</tr>
					'.$bedroomDetails.'
				</table>
